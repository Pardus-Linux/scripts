    ...
    if "#" not in line.strip() and ":" in line.strip():
        ...
        for userid in c.fetchall():
            ...
            if N_bug != 0:
                ...
                AND bugs_activity.bug_when >= DATE_SUB( CURDATE( ) , INTERVAL 1 MONTH )
                )
                UNION (
                ...
                AND longdescs.bug_when >= DATE_SUB( CURDATE( ) , INTERVAL 1 MONTH )"""
...
print activityLW
"""
print("Number of Bugs Fixed Since Last Month")
print("=====================================")
...
plt.title('Number of bugs fixed since last month')
...
plt.savefig("fixed_bugs_lm.png")
print(".. image:: fixed_bugs_lm.png")
...
# add some
plt.xlabel('Number of Bugs')
plt.title('Number of commented bugs since last month')
plt.yticks(ind+width, devNames )


autolabel(rects3)

plt.savefig("commented_bugs_lm.png")
print(".. image:: commented_bugs_lm.png")
