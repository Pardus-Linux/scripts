    ...
    if "#" not in line.strip() and ":" in line.strip():
        ...
        for userid in c.fetchall():
            ...
            if N_bug != 0:
                ...
                AND bugs_activity.bug_when >= DATE_SUB( CURDATE( ) , INTERVAL 1 YEAR )
                )
                UNION (
                ...
                AND longdescs.bug_when >= DATE_SUB( CURDATE( ) , INTERVAL 1 YEAR)"""
...
print activityLW
"""
print("Number of Bugs Fixed Since Last Year")
print("=====================================")
...
plt.title('Number of bugs fixed since last year')
...
plt.savefig("fixed_bugs_ly.png")
print(".. image:: fixed_bugs_ly.png")
...
# add some
plt.xlabel('Number of Bugs')
plt.title('Number of commented bugs since last year')
plt.yticks(ind+width, devNames )


autolabel(rects3)

plt.savefig("commented_bugs_ly.png")
print(".. image:: commented_bugs_ly.png")
